...
class ControlInfo extends StatelessWidget {
  const ControlInfo({super.key, required this.unit});

  final ControlModel unit;
        ...
        children: [
          ...
          SectionBox(
            children: [
              ...
              InfoRow(title: 'الموديل', value: unit.model),
            ],
          ),
          const SizedBox(height: 12),
          SectionBox(
            children: [
              Text('مواصفات اللوحة', style: AppTextStyles.textStyle16),
              InfoRow(title: 'موديل اللوحة', value: unit.board.model),
              InfoRow(title: 'نشطة', value: unit.board.isActive ? 'نعم' : 'لا'),
              unit.board.stopCode != null
                  ? InfoRow(
                      title: 'كود التوقف',
                      value: unit.board.stopCode.toString())
