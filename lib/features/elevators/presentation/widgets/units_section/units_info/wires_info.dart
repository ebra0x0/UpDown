...
class WiresInfo extends StatelessWidget {
  const WiresInfo({super.key, required this.unit});

  final WiresModel unit;
        ...
        children: [
          ...
          SectionBox(
            children: [
              ...
              InfoRow(title: 'عدد الأسلاك', value: unit.count.toString()),
              InfoRow(title: 'الطول (متر)', value: unit.lenght.toString()),
            ],
          ),
          const SizedBox(height: 12),
          SectionBox(
